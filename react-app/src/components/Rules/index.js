    ...
    <div className="rules-outer-div">
        <div className="rules-inner-div">
            ...
            <div className="exception-div">
                <p className="exception">* Players may be awarded assists for winning penalties that have been scored, or for a shot that lead directly to an own goal</p>
                <p className="exception">* Man of the match and assist statistics are harder to procure reliably the further back in time we go</p>
                <p className="exception">* More players will continue to be added to the game. Gathering individual gameday stats is a time consuming, and error-prone process</p>
            </div>
        </div>
    </div>
  )
